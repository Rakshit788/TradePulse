          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              {isLoggedIn ? (
                ...
                <Button className="bg-indigo-600 hover:bg-indigo-500 text-white" size="lg" onClick={() => setIsLoggedIn(true)}>
                  Start Trading Now
                  <ArrowRight className="h-5 w-5 ml-2" />
                </Button>
              )}
              ...
              <Link href="/leaderboard">
                <Button variant="outline" size="lg" className="border-gray-600  text-black">
